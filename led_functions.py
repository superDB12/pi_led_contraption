...
class PiLedContraption:
    ...
    def led_off(self, user_input_led_number):
        if 1 <= user_input_led_number < 7:
            self._led_order[(user_input_led_number - 1)].off()
            print("LED {} is off".format(user_input_led_number))
        else:
            print("invalid LED")
            print("LED {} is off".format(i))
